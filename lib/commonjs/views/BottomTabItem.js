...
var _AnimationTabBarIcon = _interopRequireDefault(require("./AnimationTabBarIcon"));
...
function BottomTabBarItem({
  ...
  const renderIcon = ({
    ...
    const activeOpacity = focused ? 1 : 1;
    const inactiveOpacity = focused ? 0 : 1;
    return /*#__PURE__*/_react.default.createElement(_AnimationTabBarIcon.default, {
      route: route,
